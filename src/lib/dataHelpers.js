export const extractList = response => {
  const candidates = [
    ...
    response?.data?.payments, response?.data?.queries, response?.data?.quries,
    response?.data?.userQueries, response?.data?.userQuries,
    ...
    response?.payments, response?.queries, response?.quries,
    response?.userQueries, response?.userQuries,
