...
const sections = [
  {
    ...
    body: [
      'At VS Group, we value the privacy of our customers and are committed to protecting their personal information. We collect customer details such as name, address, contact information, and booking details solely for the purpose of processing bookings and providing our services.',
  ...
  },
  {
    ...
    bullets: [
      'Once an order is placed and confirmed, cancellation requests may be accepted at the sole discretion of VS Group.',
      ...
      'If a product or service becomes unavailable due to unforeseen circumstances from our side, VS Group may offer an alternative service or issue a refund at its discretion.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'VS Group shall not be liable for any indirect or consequential losses arising from booking cancellations or changes.',
    ],
  },
  {
...
export default function Privacy() {
  return (
    <div className="page privacy-page">
      <PageHeader eyebrow="Trust and transparency" title="Privacy Policy" text="Policy details used in the mobile app, adapted for the web portal." />
      <Card className="privacy-hero-card">
        <ShieldCheck />
        <div>
          <h2>VS Group Policies</h2>
