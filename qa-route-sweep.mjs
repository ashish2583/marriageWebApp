...
const routes = [
  ...
  ['customer', '/app/payment-related-policy', 'Payment Related Policy'],
  ...
  ['vendor', '/app/payment-related-policy', 'Payment Related Policy'],
  ...
  ['admin', '/app/payment-related-policy', 'Payment Related Policy'],
